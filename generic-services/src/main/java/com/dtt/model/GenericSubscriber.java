 ...
 * 
 */
@Entity(name = "GenericSubscriber")
@Table(name="subscribers")
//@NamedQuery(name="Subscriber.findAll", query="SELECT s FROM Subscriber s")
public class GenericSubscriber implements Serializable {
	...
	public GenericSubscriber() {
		// Required by JPA: default constructor must be empty for entity instantiation
	}
