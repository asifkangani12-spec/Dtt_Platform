...
@Service
public class RaKafkaSender {
    static Logger logger = LoggerFactory.getLogger(RaKafkaSender.class);
    private static final String CLASS = "KafkaSender";

    private final KafkaTemplate<String, Object> kafkaTemplate;

    public RaKafkaSender(
            @Qualifier("orgKafkaTemplate") KafkaTemplate<String, Object> kafkaTemplate
    ) {
