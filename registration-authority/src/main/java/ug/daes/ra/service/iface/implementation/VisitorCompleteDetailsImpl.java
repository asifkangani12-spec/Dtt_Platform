...
import ug.daes.ra.repository.iface.RaVisitorCompleteDetailsRepository;
...
public class VisitorCompleteDetailsImpl implements VisitorCompleteDetailsIface {
	...
	private final RaVisitorCompleteDetailsRepository raVisitorCompleteDetailsRepository;
	private final MessageSource messageSource;

	public VisitorCompleteDetailsImpl(
			RaVisitorCompleteDetailsRepository raVisitorCompleteDetailsRepository,
			MessageSource messageSource) {
		this.raVisitorCompleteDetailsRepository = raVisitorCompleteDetailsRepository;
	...
	public ApiResponse getDocumentDetailsBydocumentId(String documentNumber, String documentType) {
		try {
			...
			RAVisitorCompleteDetails visitorCompleteDetails = raVisitorCompleteDetailsRepository
