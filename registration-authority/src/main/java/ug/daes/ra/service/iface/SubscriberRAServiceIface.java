...
public interface SubscriberRAServiceIface {
    ...
    ApiResponse compareImage(String suid, String capturedImage) throws RAServiceException;

	ApiResponse getFeatures(String suid, String capturedImage) throws RAServiceException;

	ApiResponse getSubscriberPhoto(String suid) throws RAServiceException;
