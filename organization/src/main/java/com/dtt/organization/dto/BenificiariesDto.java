...
public class BenificiariesDto {
    ...
    private List<OrgBeneficiaryValidity> beneficiaryValidities;

   private List<OrgBeneficiariedPrivilegeService> beneficiariedPrivilegeList;




    public List<OrgBeneficiariedPrivilegeService> getBeneficiariedPrivilegeList() {
        return beneficiariedPrivilegeList;
    }

    public void setBeneficiariedPrivilegeList(List<OrgBeneficiariedPrivilegeService> beneficiariedPrivilegeList) {
    ...
    public List<OrgBeneficiaryValidity> getBeneficiaryValidities() {
        return beneficiaryValidities;
    }

    public void setBeneficiaryValidities(List<OrgBeneficiaryValidity> beneficiaryValidities) {
