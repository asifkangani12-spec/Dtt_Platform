...
public class TrustedController {
	...
	public ApiResponse updateTrustedUser(@RequestBody OnbTrustedUser trustedUser) {
	...
	public ApiResponse addTrustedUser(@RequestBody List<OnbTrustedUser> trustedUser) {
