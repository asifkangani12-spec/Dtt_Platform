...
public class EditTemplateDTO implements Serializable{
	...
	private Map<String, OnbMapMethodOnboardingStep> steps;
	...
	public Map<String, OnbMapMethodOnboardingStep> getSteps() {
		return steps;
	}

	public void setSteps(Map<String, OnbMapMethodOnboardingStep> steps) {
		this.steps = steps;
	}
