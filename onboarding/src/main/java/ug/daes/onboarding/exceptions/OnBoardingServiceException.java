...
public class OnBoardingServiceException {
    ...
    private final OnboardingSentryClientExceptions onboardingSentryClientExceptions;

    public OnBoardingServiceException(MessageSource messageSource, OnboardingSentryClientExceptions onboardingSentryClientExceptions) {
        this.messageSource = messageSource;
        this.onboardingSentryClientExceptions = onboardingSentryClientExceptions;
    }
    ...
    public void captureExceptionInSentry(Exception e, String suid,String methodName,String controllerName ) {
            onboardingSentryClientExceptions.captureTags(suid, null, methodName, controllerName);
            onboardingSentryClientExceptions.captureExceptions(e);
    }
}
