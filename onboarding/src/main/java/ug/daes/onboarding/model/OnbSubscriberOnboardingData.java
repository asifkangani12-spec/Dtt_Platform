 ...
 * 
 */
@Entity(name = "OnbSubscriberOnboardingData")
...
public class OnbSubscriberOnboardingData implements Serializable {
	...
	public OnbSubscriberOnboardingData() {
		// OnbSubscriberOnboardingData
	}
