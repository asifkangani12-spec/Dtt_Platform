 ...
 * 
 */
@Entity(name = "OnbSubscriberDeviceHistory")
...
public class OnbSubscriberDeviceHistory implements Serializable {
	...
	public OnbSubscriberDeviceHistory() {
		// OnbSubscriberDeviceHistory
	}
