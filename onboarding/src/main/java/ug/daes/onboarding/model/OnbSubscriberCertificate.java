 ...
 * 
 */
@Entity(name = "OnbSubscriberCertificate")
...
public class OnbSubscriberCertificate implements Serializable {
	...
	public OnbSubscriberCertificate() {
		//OnbSubscriberCertificate
	}
