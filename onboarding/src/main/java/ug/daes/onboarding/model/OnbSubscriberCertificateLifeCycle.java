 ...
 * 
 */
@Entity(name = "OnbSubscriberCertificateLifeCycle")
...
public class OnbSubscriberCertificateLifeCycle implements Serializable {
	...
	public OnbSubscriberCertificateLifeCycle() {
		// OnbSubscriberCertificateLifeCycle
	}
