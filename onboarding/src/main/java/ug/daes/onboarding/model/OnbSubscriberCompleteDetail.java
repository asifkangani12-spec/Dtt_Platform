 ...
 *
 */
@Entity(name = "OnbSubscriberCompleteDetail")
...
public class OnbSubscriberCompleteDetail implements Serializable {
	...
	public OnbSubscriberCompleteDetail() {
		// OnbSubscriberCompleteDetail
	}
