...
public class AppUtil {
    ...
    private static final String res = "user";
    ...
    /** The Constant CLASS. */
    static final String CLASS = "AppUtil";
    ...
    public static String getUnameFromDecryptedRefreshToken(String token) {
        ...
        return parts[1]; // 034556
    }

    public static String genrateHashCode(Object obj) {
        int sha256 = obj.hashCode();
        return Integer.toString(sha256);
    }
    ...
    public static List<String> getListFromPathJson(String zipPath) {
        ...
        try {
            if (!zipPath.isEmpty() && !zipPath.isEmpty()){
	...
	public static String getTotalTime(String t1,String t2) throws ParseException {
		...
		Date time2 = smpdate2.parse(t2);
		 ...
		 return Double.toString(difference_In_Time/1000.0);
